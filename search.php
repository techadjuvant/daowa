	...
	<section id="main" class="page-template">
        <div class="container">
            <div class="blog-posts em-site-content">
				<div class="row">
					<?php 
						$search_page_sidebar_position = get_theme_mod("search_page_sidebar_position", "no-sidebar"); 
						if($search_page_sidebar_position === "right-sidebar") : 
					?>
					...
					<?php endif; ?>
					<?php if($search_page_sidebar_position === "left-sidebar") : ?>
						<div class="col-md-3 col-xs-12 text-center feature bordered bg-color-blog-posts">
							<?php get_sidebar(); ?>                  
						</div>
						<div class="col-md-9 col-xs-12">
					...
					<?php endif; ?>
					<?php if($search_page_sidebar_position === "no-sidebar") : ?>
